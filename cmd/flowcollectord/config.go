...
func loadConfig() config {
	...
	classifierIPASN := flag.String("classifier-ip-asn-table", envString("FC_CLASSIFIER_IP_ASN_TABLE", "default.ip_asn_prefixes_current"), "public IP→ASN fallback (iptoasn); empty env still uses this default")
