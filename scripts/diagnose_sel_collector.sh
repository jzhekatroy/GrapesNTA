...
echo "  # full sel setup:"
echo "  cd /root/GrapesNTA && ./attic/scripts/prod_setup_sel_collector.sh"
echo "  # re-cutover XDP:"
echo "  cd /root/GrapesNTA && XDP_ALLOW_NO_NETFLOW_RULE=1 ./attic/scripts/prod_enable_xdpflowd_sel.sh"
echo "  # live logs:"
